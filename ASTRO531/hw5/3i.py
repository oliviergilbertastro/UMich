...
ax2 = plt.subplot(111)
ax2.plot(logT, v_conv/cs, ls="-", lw=2, color="red", label=r"$v_\mathrm{conv}$")
ax2.legend(fontsize=17)
ax2.invert_xaxis()
ax2.set_xlabel(r"$\log T$ [$\mathrm{K}$]")
ax2.set_ylabel(r"Convection velocity [$v_\mathrm{conv}/c_s$]")
#ax2.set_yscale("log")
# create top axis
secax = ax2.twiny()
...
plt.tight_layout()
plt.savefig(r"ASTRO531\hw5\plot3i.pdf")
plt.show()