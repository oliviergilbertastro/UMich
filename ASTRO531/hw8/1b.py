...
ax = plt.subplot(111)
ax.plot(profile_05_Msun["logT"],radius_norm_05,marker="None",ls="-",label=r"0.5M_\odot")
ax.plot(profile_5_Msun["logT"],radius_norm_5,marker="None",ls="-",label=r"5M_\odot")
